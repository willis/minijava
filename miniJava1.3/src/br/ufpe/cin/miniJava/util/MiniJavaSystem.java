...
public class MiniJavaSystem implements Serializable {
	...
	public synchronized int readInt() {
		...
		try {
			...
			MiniJavaSystem.err.println(e.toString());
			MiniJavaSystem.err.println("O valor digitado não "
					+ "corresponde a um int valido !!! Os valores para um int estão no intervalo ["
	...
	/**
	 * Método que termina a execução da máquina virtual,
	 * ou seja, fecha o programa que estiver sendo executado.
	 */	
	public void close() {
		System.exit(0);
	}
