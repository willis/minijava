...
public class Window extends Container {
	 ...
	 * 
	 * Observe que, por padrão, as janelas quando são criadas,
	 * estão com a propriedade de sair ao fechar setada pra
	 * <code>true</code>, ou seja, quando as janelas são fechadas,
	 * irão fechar o programa também. Consulte o método exitOnClose
	 * desta classe para ver como evitar isto.
	 * 
	 * @see br.ufpe.cin.miniJava.gui.Window#exitOnClose(boolean)
	 */
	public Window(){		
	 ...
	 * fornece o painel em que os outros componentes
	...
	* Altera  o painel de conteúdo da janela, ou seja 
	 * altera  o painel em que os outros componentes
	 * da janela são inseridos.
	 * 
	 * 
	 ...
	 * dois caminhos descritos a seguir: fechar a janela e
	...
	*Fornece a cor de fundo da janela, esta é representada 
	...
	/**
     * Insere um componente à janela, sem especificar as coordenadas
     * onde este componente será inserido.
     * 
     ...
     * 
     * As coordenadas são em relação à parte superior esquerda do
     * painel de conteúdo desta janela, que é a coordenada (0,0).
     * 
     * @param comp <CODE>Component</CODE> que será adicionado e que
     * receberá um novo ouvinte.
     * @param x posição X do componente, em relação à borda esquerda desta janela.
     * @param y posição Y do componente, em relação à parte superior desta janela.
     */
