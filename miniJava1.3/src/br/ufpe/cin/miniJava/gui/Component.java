...
public class Component {
	...
	* @return <CODE>Color</CODE> com as propriedades de cor do componente,
	...
	/**
	 * Retorna uma referência para o objeto que contém este componente.
	 * Caso este componente seja uma janela, ou caso este componente não
	 * esteja inserido em nenhuma janela, ele retornará <code>null</code>.
	 * 
	 * @return <code>Window</code> onde o component está inserido.
	 */
	// METODO DEFAULT PARA NAO APARECER NO JAVADOC
	// Basta trocar pra public para painel ter "utilidade"
	// (tendo acesso a janela eh melhor)...
	Component getParent() {
		return this.parent;
	}
	// METODO DEFAULT PARA NAO APARECER NO JAVADOC
