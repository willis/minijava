...
public class TextArea extends AbstractText {
	...
	public void setFont(Font f) {
		if (f != null) {
			this.textArea.setFont(f.getFont());
			this.scrollPane.setFont(f.getFont());
		}
	...
	public void setBackground(Color c) {
		if (c != null) {
			this.scrollPane.setBackground(c.getColor());
			this.textArea.setBackground(c.getColor());
		}
	} 
	/**
	...
	public void setForeground(Color c) {
		if (c != null) {
			this.scrollPane.setForeground(c.getColor());
			this.textArea.setForeground(c.getColor());
		}
	} 
	/**
