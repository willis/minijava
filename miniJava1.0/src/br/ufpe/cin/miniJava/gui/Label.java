...
public class Label extends Component{
    ...
    /**
     * Cria um label com o texto padrão "<i>Label</i>".
     */
	public Label(){		
     ...
     * 
     * @param text texto a ser inicializado no label. 
     */
    ...
    /**
     * Cria um label com um texto, e com alinhamento.
     * 
     * @param text texto a ser inicializado no label.
