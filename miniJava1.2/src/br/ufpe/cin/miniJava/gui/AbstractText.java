...
abstract class AbstractText extends Component {
	 ...
	 * 
	 * @return <code>int</code> com o valor do objeto desta classe.
	 * @throws InvalidConversionException se o valor não puder ser convertido para inteiro.
	 */
	 ...
	 * Fornece um <code>double</code> com o valor do objeto desta classe.
	 * 
	 * Caso o texto localizado no objeto desta classe não for reconhecido como um <code>double</code>,
	 * uma <code>InvalidConversionException</code> será lançada.
	 * 
	 * @return <code>double</code> com o valor do objeto desta classe.
	 ...
	 * 
	 * @return <code>true</code> se o objeto desta classe for editável.
	 */
	...
	public void selectAll() {
	  ...
	  * 
	  * @param b <code>boolean</code> que indicará se o objeto desta classe
